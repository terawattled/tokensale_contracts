...
contract('cloneLedToken', ([fund, buyer, buyer2, wallet]) => {
  let tokenSale
  let ledToken
  let ledTokenFactory
  ...
  beforeEach(async function() {
    ...
    ledTokenFactory = await TokenFactory.new()
    ledTokenFactoryAddress = await getAddress(ledTokenFactory)

    ledToken = await LedToken.new(
      ledTokenFactoryAddress,
      '0x0',
      0,
      'Led Token',
      'PRFT'
