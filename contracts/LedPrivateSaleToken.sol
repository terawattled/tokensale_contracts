...
/**
 * @title LedPrivateSaleToken (LEDP)
...
contract LedPrivateSaleToken is ERC20, Controllable {
  ...
  string public constant name = "Led PrivateSale Token";
